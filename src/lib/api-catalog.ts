...
export const apiCatalog: ApiModule[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { action: 'list-edit-requests', method: 'POST', description: 'List visible receipt edit requests' },
  ...
  },
  {
    ...
    actions: [
      ...
      { action: 'review-edit', method: 'POST', description: 'Approve or reject a pending detail edit request (admin)', bodyExample: { action: 'review-edit', requestId: 'request-id', decision: 'approve', comment: 'looks good' } },
      { action: 'list-edit-requests', method: 'POST', description: 'List visible payment detail edit requests' },
    ],
  },
  {
    endpoint: '/api/swift',
    ...
    actions: [
      ...
      { action: 'list-edit-requests', method: 'POST', description: 'List visible SWIFT edit requests' },

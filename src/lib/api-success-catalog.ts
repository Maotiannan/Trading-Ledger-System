...
const exactSuccessMessages: Record<string, Record<SupportedLocale, string>> = {
  ...
  '收据修改申请已提交，等待管理员同意': {
    zh: '收据修改申请已提交，等待管理员同意',
    en: 'Receipt edit request submitted. Waiting for administrator approval.',
  },
  '收据修改申请已通过': { zh: '收据修改申请已通过', en: 'Receipt edit request approved.' },
  '收据修改申请已拒绝': { zh: '收据修改申请已拒绝', en: 'Receipt edit request rejected.' },
  '修改已完成': { zh: '修改已完成', en: 'Update completed.' },
  '余额转移已撤销': { zh: '余额转移已撤销', en: 'Balance transfer reversed.' },

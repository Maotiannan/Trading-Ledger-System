...
> 修复状态（2026-06-05，v1.0.172）：A1/A3/A4/A5、B1/B2/B3/B4、C1 第一阶段、C2、D1/D2/D3 已落地；D5 已完成服务端/API 日志收口，浏览器端 hook 的调试日志暂保留。C3/C4/D4/D6 属较大范围治理，保留为后续专项，避免在一次安全修复中引入大面积行为变化。

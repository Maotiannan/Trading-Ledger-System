...
export const apiCatalog: ApiModule[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { action: 'preview-image', method: 'GET', description: 'Serve a payment detail preview image; generates and attaches export-pic output when no uploaded image exists', bodyExample: { detailId: 'detail-id' } },
      { action: 'export-pic', method: 'GET', description: 'Download payment detail export picture', bodyExample: { detailId: 'detail-id' } },

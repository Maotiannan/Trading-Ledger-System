...
describe('ReceiptManager', () => {
  beforeEach(() => {
    ...
    mockUseReceiptGenerator.mockReturnValue({
      ...
      generatorPaymentMode: 'Espèces',
      setGeneratorPaymentMode: jest.fn(),
      generatorFraisStatus: 'Payé',
      setGeneratorFraisStatus: jest.fn(),
      generatorPaymentType: 'Standard',
      setGeneratorPaymentType: jest.fn(),
      generatorReceivedBy: 'Mamadou Dian Diallo',
      setGeneratorReceivedBy: jest.fn(),

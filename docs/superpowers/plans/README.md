...
| Plan | Status | Outcome |
| --- | --- | --- |
| `2026-08-27-receipt-transfer-reversal.md` | `ACTIVE` | Implementation and isolated API coverage are complete; full gates, verified backup restore/migration rehearsal, PR/CI, deployment, and one-time incident repair remain. |

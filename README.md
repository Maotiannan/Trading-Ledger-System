...
- 当前版本：`1.0.111`
- 本次更新：收据管理新增“收据修改审批”能力。`SALES` 现在可以对自己可见范围内的收据提交修改申请，提交后会提示“成功提交，等待管理员同意”；`ADMIN` 对可见收据的修改会直接生效，并提示“修改已完成”。
- 可修改字段限定为：`Receipt No. / Payment Date / INV NO / MARK / Payer / Phone`。待审批期间同一条收据不能重复提交新的修改申请。
